  ...
  return (
    <div className="App">
      ...
      <div className="input-container">
        ...
        <input id="greeting-message" type="text" onChange={(even) => {setGreetingInputText(even.target.value)}} />
      </div>

      <div className="buttons">
        <button onClick={() => setGreetingText(greetingInputText) } >Update text</button>
      </div>
    </div>
  );
}
